...
This document describes the project board structure for tracking and managing work across the Claw repository.

## Overview

The Claw project uses GitHub Project Boards to organize and track work across different categories and priorities.
...
- `award: bounty` - Has bounty attached
...
### Q2 2026 (April - June)
- Complete v0.2.0 (production readiness)
...
**View Board:**
- https://github.com/orgs/SuperInstance/projects/1
