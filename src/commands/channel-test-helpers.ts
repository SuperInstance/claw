...
type ChannelOnboardingAdapterPatch = Partial<Pick<ChannelOnboardingAdapter, "configure" | "configureInteractive" | "configureWhenConfigured" | "getStatus">>;
...
export function patchChannelOnboardingAdapter(channel: ChannelChoice, patch: ChannelOnboardingAdapterPatch): () => void {
