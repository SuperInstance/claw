...
const PROVIDER_PLUGIN_IDS: Array<{
    pluginId: string;
    providerId: string;
}> = [
...
function resolveChannelConfig(cfg: OpenClawConfig, channelId: string): Record<string, unknown> | null {
...
function isStructuredChannelConfigured(cfg: OpenClawConfig, channelId: string, env: NodeJS.ProcessEnv, spec: StructuredChannelConfigSpec): boolean {
...
export function isChannelConfigured(cfg: OpenClawConfig, channelId: string, env: NodeJS.ProcessEnv = process.env): boolean {
...
function resolveConfiguredPlugins(cfg: OpenClawConfig, env: NodeJS.ProcessEnv, registry: PluginManifestRegistry): PluginEnableChange[] {
...
function shouldSkipPreferredPluginAutoEnable(cfg: OpenClawConfig, entry: PluginEnableChange, configured: PluginEnableChange[], env: NodeJS.ProcessEnv): boolean {
...
export function applyPluginAutoEnable(params: {
    ...
    const registry = params.manifestRegistry ?? loadPluginManifestRegistry({ config: params.config, env });
