...
export function normalizeFailoverDecisionObservationBase(base: FailoverDecisionLoggerBase): FailoverDecisionLoggerBase {
    return {
        ...base,
...
export function createFailoverDecisionLogger(base: FailoverDecisionLoggerBase): (decision: FailoverDecisionLoggerInput["decision"], extra?: Pick<FailoverDecisionLoggerInput, "status">) => void {
