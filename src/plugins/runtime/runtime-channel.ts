...
import { listDiscordDirectoryGroupsLive, listDiscordDirectoryPeersLive, } from "../../../extensions/discord/src/directory-live.js";
...
import { createThreadDiscord, deleteMessageDiscord, editChannelDiscord, editMessageDiscord, pinMessageDiscord, sendDiscordComponentMessage, sendMessageDiscord, sendPollDiscord, sendTypingDiscord, unpinMessageDiscord, } from "../../../extensions/discord/src/send.js";
import { auditTelegramGroupMembership, collectTelegramUnmentionedGroupIds, } from "../../../extensions/telegram/src/audit.js";
...
import { deleteMessageTelegram, editMessageReplyMarkupTelegram, editMessageTelegram, pinMessageTelegram, renameForumTopicTelegram, sendMessageTelegram, sendPollTelegram, sendTypingTelegram, unpinMessageTelegram, } from "../../../extensions/telegram/src/send.js";
        ...
        discord: {
            ...
            typing: {
                ...
                start: async ({ channelId, accountId, cfg, intervalMs }) => await createDiscordTypingLease({
                    ...
                    cfg,
                    intervalMs,
                    pulse: async ({ channelId, accountId, cfg }) => void (await sendTypingDiscord(channelId, {
                        accountId,
                        cfg,
                    })),
                }),
        ...
        telegram: {
            ...
            typing: {
                ...
                start: async ({ to, accountId, cfg, intervalMs, messageThreadId }) => await createTelegramTypingLease({
                    ...
                    intervalMs,
                    messageThreadId,
                    pulse: async ({ to, accountId, cfg, messageThreadId }) => await sendTypingTelegram(to, {
                        accountId,
                        cfg,
                        messageThreadId,
                    }),
            ...
            conversationActions: {
                ...
                clearReplyMarkup: async (chatIdInput, messageIdInput, opts = {}) => await editMessageReplyMarkupTelegram(chatIdInput, messageIdInput, [], opts),
