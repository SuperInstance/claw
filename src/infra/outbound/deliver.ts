...
type ChannelHandler = {
    ...
    sendPayload?: (payload: ReplyPayload, overrides?: {
        replyToId?: string | null;
        threadId?: string | number | null;
    }) => Promise<OutboundDeliveryResult>;
    sendText: (text: string, overrides?: {
        replyToId?: string | null;
        threadId?: string | number | null;
    }) => Promise<OutboundDeliveryResult>;
    sendMedia: (caption: string, mediaUrl: string, overrides?: {
        replyToId?: string | null;
        threadId?: string | number | null;
    }) => Promise<OutboundDeliveryResult>;
};
...
function createPluginHandler(params: ChannelHandlerParams & {
...
function createChannelOutboundContextBase(params: ChannelHandlerParams): Omit<ChannelOutboundContext, "text" | "mediaUrl"> {
    return {
        cfg: params.cfg,
        to: params.to,
...
function normalizePayloadsForChannelDelivery(payloads: ReplyPayload[], channel: Exclude<OutboundChannel, "none">, _cfg: OpenClawConfig, _to: string, _accountId?: string): ReplyPayload[] {
...
async function deliverOutboundPayloadsCore(params: DeliverOutboundPayloadsCoreParams): Promise<OutboundDeliveryResult[]> {
    const { cfg, channel, to, payloads } = params;
    const accountId = params.accountId;
    const deps = params.deps;
    const abortSignal = params.abortSignal;
    const sendSignal = resolveOutboundSendDep<typeof sendMessageSignal>(params.deps, "signal") ?? sendMessageSignal;
    ...
    const signalMaxBytes = isSignalChannel
        ...
        : undefined;
    const sendTextChunks = async (text: string, overrides?: {
        replyToId?: string | null;
        threadId?: string | number | null;
    }) => {
