"""
Tutorial 01: Basic Consensus Implementation

A hands-on introduction to distributed consensus algorithms.
This module implements three types of consensus:
1. Simple majority voting
2. Concurrent proposal handling
3. Fault-tolerant Paxos-inspired consensus
"""
...
def main():
    ...
    print("\n" + "="*60)
    print("TUTORIAL 01: BASIC CONSENSUS")
    print("Running all examples...")
    print("="*60)

    # Part 1: Simple Majority
    print("\n\n# PART 1: SIMPLE MAJORITY VOTING")
    simple = SimpleConsensus(num_nodes=5)
    simple.run_example()

    # Part 2: Concurrent Proposals
    print("\n\n# PART 2: CONCURRENT PROPOSALS")
    concurrent = ConcurrentConsensus(num_nodes=5)

    for round_num in range(3):
        print(f"\n### Round {round_num + 1} ###")
        concurrent.proposals = []
        concurrent.decided_value = None
        concurrent.simulate_concurrent_proposals()
        result = concurrent.decided_value
        print(f"Final decision: {result}")

    # Part 3: Fault-Tolerant
    print("\n\n# PART 3: FAULT-TOLERANT CONSENSUS")
    ft_consensus = FaultTolerantConsensus(num_nodes=5)
    ft_consensus.simulate_with_failures()
